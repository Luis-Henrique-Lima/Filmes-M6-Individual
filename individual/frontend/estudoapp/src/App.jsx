...
function App() {
  ...
  async function createContent(event) {
    try {
      ...
      await ContentsApi().createContent(
        req.genero.value, req.diretor.value, Number(req.ano.value)
      ).then(data => {
        return data.json()
      }).then(res => {
        setContents([...contents, {
          id: res.contentId,
          genero: req.genro.value,
          diretor: req.diretor.value,
  ...
  async function updateContent(event) {
    try {
      ...
      await ContentsApi().updateContent(
        selectedContent.id, req.genero.value, req.diretor.value, Number(req.ano.value)
      )
  ...
  return(
    ...
    >
      ...
      <img src="https://t.ctcdn.com.br/K04j_fY2uLXtJftLIWqzn10Krq0=/720x405/smart/filters:format(webp)/i397070.jpeg" alt="" srcset="" />
